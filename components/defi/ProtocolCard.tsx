...
export default function ProtocolCard({ protocol }: ProtocolCardProps) {
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4 sm:p-5 hover:shadow-md hover:border-gray-200 transition-all animate-fade-in-up cursor-pointer group">
      {/* 顶部：Logo + 名称 + 分类 */}
      ...
      <div className="space-y-3">
        ...
        {protocol.url && (
          <a
            ...
            className="flex items-center justify-center gap-2 w-full px-4 py-2.5 bg-blue-500 text-white text-sm font-semibold rounded-lg hover:bg-blue-600 transition-colors active:scale-95"
          >
            访问官网
